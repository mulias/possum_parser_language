  ...
  ============0:@input.offset=============
  0000    | NativeCode 1: inputOffsetNative
  0002    | End
  ========================================
  ...
  0000    | SetInputMark
  0001    | GetLocal 0
  0003    | NativeCode 3: setInputPositionNative
  ...
  ========================================
  0000    | PushVar Pos
  0002    | CallFunctionConstant 0: @input.offset
  0004    | DestructurePlan 0: bind Pos
  0006    | TakeRight 6 -> 17
  0009    | GetConstant 1: @at
  0011    | GetLocalMove 1
  0013    | GetLocalMove 0
  ...
  0003    | Or 3 -> 8
  0006    | CallTailFunctionConstant 2: succeed
  0008    | End
  ========================================
  ...
  0001    | CallFunctionLocal 0
  0003    | Or 3 -> 17
  0006    | CallFunctionConstant 6: char
  0008    | TakeRight 8 -> 17
  0011    | GetConstant 7: find
  0013    | GetLocalMove 0
  ...
  ========================================
  0000    | GetConstant 8: array
  0002    | GetConstant 9: @fn0
  0004    | CreateClosure 1
  0006    | CaptureLocal 0
  0008    | CallFunction 1
  0010    | JumpIfFailure 10 -> 20
  0013    | GetConstant 10: maybe
  0015    | GetConstant 11: @fn1
  0017    | CallFunction 1
  0019    | TakeLeft
  0020    | End
  ========================================
  ...
  0014    | Or 14 -> 30
  0017    | CallFunctionConstant 6: char
  0019    | TakeRight 19 -> 30
  0022    | GetConstant 13: find_before
  0024    | GetLocalMove 0
  0026    | GetLocalMove 1
  ...
  ========================================
  0000    | GetConstant 8: array
  0002    | GetConstant 14: @fn2
  0004    | CreateClosure 2
  0006    | CaptureLocal 0
  0008    | CaptureLocal 1
  0010    | CallFunction 1
  0012    | JumpIfFailure 12 -> 26
  0015    | GetConstant 10: maybe
  0017    | GetConstant 15: @fn3
  ...
  0004    | DestructurePlan 1: tmpl((eq 0 + bind N))
  0006    | TakeRight 6 -> 11
  0009    | GetLocalMove 1
  0011    | End
  ========================================
  ...
  ========================================
  0000    | SetInputMark
  0001    | CallFunctionConstant 6: char
  0003    | ConditionalThen 3 -> 11
  0006    | CallTailFunctionConstant 4: @fail
  0008    | Jump 8 -> 13
  0011    | CallTailFunctionConstant 2: succeed
  0013    | End
  ========================================
  ...
  ========================================
  0000    | GetConstant 17: surround
  0002    | GetLocalMove 0
  0004    | GetConstant 18: @fn4
  0006    | CallFunction 2
  0008    | JumpIfFailure 8 -> 14
  0011    | CallFunctionConstant 19: end_of_input
  0013    | TakeLeft
  0014    | End
  ========================================
  ...
  0006    | GetConstant 10: maybe
  0008    | GetLocal 1
  0010    | CallFunction 1
  0012    | Merge
  0013    | Or 13 -> 28
  0016    | GetConstant 10: maybe
  0018    | GetLocalMove 0
  0020    | CallFunction 1
  ...
  0005    | GetConstant 13: find_before
  0007    | GetLocalMove 0
  0009    | GetLocalMove 1
  ...
  0000    | PushVar stop
  0002    | SetClosureCaptures
  0003    | GetConstant 16: chars_until
  0005    | GetLocalMove 0
  0007    | CallTailFunction 1
  0009    | End
  ========================================
  ...
  maybe(whitespace)
  ========================================
  0000    | GetConstant 10: maybe
  0002    | GetConstant 20: whitespace
  0004    | CallTailFunction 1
  0006    | End
  ========================================
