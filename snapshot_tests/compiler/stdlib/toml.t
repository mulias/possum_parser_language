  ...
  0008    | MatchWindowEnter 5 fail->28
  0012    | MatchScrutinee r0
  0014    | MatchType r0 array
  ...
  0000    | PushVar2 V
  0003    | GetLocalMove l0
  0005    | JumpIfFailure 5 -> 51
  0008    | MatchWindowEnter 6 fail->49
  0012    | MatchScrutinee r0
  0014    | MatchClaimSeed r2 <- []
  0018    | MatchType r0 object
  0021    | MatchCount r0 >=1
  0025    | GetLocalMove l1
  0027    | MatchClaimKey key=r3 val=r4 src=r0 claims=r2
  0032    | MatchWindowEnter 2 fail->42
  0036    | MatchSubScrutinee r0 ^r4
  0039    | MatchBind l2 r0
  0042    | MatchWindowExit
  0043    | MatchClaimAdd r2 r3
  0046    | Jump 46 -> 50
  0049    | MatchFail
  0050    | MatchWindowExit
