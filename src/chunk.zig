...
pub const Chunk = struct {
    ...
    pub fn disassemble(self: *Chunk, vm: VM, writer: anytype, name: []const u8, module: ?*Module) (@TypeOf(writer).Error || error{InvalidOpCode})!void {
        try writer.print("\n{s:=^40}\n", .{name});
    ...
    pub fn disassembleInstruction(self: *Chunk, vm: VM, writer: anytype, offset: usize) (@TypeOf(writer).Error || error{InvalidOpCode})!usize {
        // print address
