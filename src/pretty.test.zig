...
test {
    ...
    try case.run(struct_1,
        \\pretty.test.test_0.Struct{ .field1: bool = true, .field2: u8 = 42, .field3: f32 = 1.1e0 }
    , .{
        .inline_mode = true,
    });
    ...
    try case.run(Struct_2{},
        \\pretty.test.test_0.Struct_2
        \\  .field1: pretty.test.test_0.Struct_1
        \\    (empty)
        \\  .field2: pretty.test.test_0.Struct_1
        \\    (empty)
    , .{
    ...
    try case.run(Struct_2{},
        \\pretty.test.test_0.Struct_2{ .field1: pretty.test.test_0.Struct_1, .field2: pretty.test.test_0.Struct_1 }
    , .{
        .struct_show_empty = false,
        .inline_mode = true,
    });
    ...
    try case.run(@as(Union_2, .{ .a = 42 }),
        \\pretty.test.test_0.Union_2
        \\  .a: u8 = 42
    , .{});

    try case.run(@as(Union_2, .{ .a = 42 }),
        \\pretty.test.test_0.Union_2{ .a: u8 = 42 }
    , .{
        .inline_mode = true,
    });
    ...
    try case.run(@as(Union_4, .{ .a = 42 }),
        \\pretty.test.test_0.Union_4
        \\  .a: u8 = 42
    , .{});

    try case.run(@as(Union_4, .{ .a = 42 }),
        \\pretty.test.test_0.Union_4{ .a: u8 = 42 }
    , .{
        .inline_mode = true,
    });
    ...
    try case.run(@as(Union_3, .a),
        \\pretty.test.test_0.Union_3
        \\  .a: void = void
    , .{});

    try case.run(@as(Union_3, .a),
        \\pretty.test.test_0.Union_3{ .a: void = void }
    , .{
        .inline_mode = true,
    });
    ...
    try case.run(Type_1.a,
        \\@typeInfo(pretty.test.test_0.Type_1).Union.tag_type.?
        \\  .a
    , .{});
