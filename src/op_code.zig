...
pub const OpCode = enum(u8) {
    ...
    fn simpleInstruction(self: OpCode, writer: anytype, offset: usize) !usize {
        try writer.print("{s}\n", .{@tagName(self)});
        return offset + 1;
    }

    fn constantInstruction(self: OpCode, chunk: *Chunk, vm: VM, writer: anytype, offset: usize) !usize {
    ...
    fn patternInstruction(self: OpCode, chunk: *Chunk, vm: VM, writer: anytype, offset: usize) !usize {
    ...
    fn twoConstantsInstruction(self: OpCode, chunk: *Chunk, vm: VM, writer: anytype, offset: usize) !usize {
    ...
    fn byteInstruciton(self: OpCode, chunk: *Chunk, writer: anytype, offset: usize) !usize {
        const byte = chunk.read(offset + 1);
        try writer.print("{s} {}\n", .{ @tagName(self), byte });
        return offset + 2;
    }

    fn twoBytesInstruciton(self: OpCode, chunk: *Chunk, writer: anytype, offset: usize) !usize {
        const byte1 = chunk.read(offset + 1);
        const byte2 = chunk.read(offset + 2);
    ...
    fn jumpInstruction(self: OpCode, chunk: *Chunk, writer: anytype, offset: usize) !usize {
